...
MESSAGES = {
    ...
    'windowed_mode': 'Игра в оконном режиме, перезапускаю',
    ...
    'level_error': 'Ошибка при распознавании уровня\nБот работает только с экранами 1920x1080 и уровнями 1-99',
    ...
    'resize': 'Текущий размер окна игры: %sx%s. Меняю на 1920x1080',
    'move_offscreen': 'Перемещаю окно игры в другое измерение',
    'screen_support': 'Пока что поддерживаются только экраны 1920x1080',
