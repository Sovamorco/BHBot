    ...
    def __init__(self, settings):
        ...
        self.APP_CHANGELOGS = {
            'English': [
                ...
                '- Fixed unlocked character detection',
                '- Fixed bot autostarting during update',
            ],
            'Русский': [
                ...
                '- Починил определение доступных персонажей',
                '- Починил автозапуск во время обновления',
            ]
        }
