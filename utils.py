    ...
    def __init__(self, settings):
        ...
        self.APP_CHANGELOGS = {
            'English': [
                ...
                '- Bot now uses BitBlt instead of PrintWindow for screenshotting',
            ],
            'Русский': [
                ...
                '- Бот теперь использует BitBlt вместо PrintWindow для скриншотов',
            ]
        }
